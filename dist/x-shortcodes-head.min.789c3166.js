...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"wp-content/plugins/x-shortcodes/js/dist/site/x-shortcodes-head.min.js":[function(require,module,exports) {
var define;
...
(function (e, t, n) {
  ...
  var r = {
    ...
    this.images = e.isArray(_i) ? _i : [_i];
...
window.Modernizr = function (e, t, n) {
  ...
  !L(T, "undefined") && !L(T.call, "undefined") ? N = function N(e, t) {
    return T.call(e, t);
  } : N = function N(e, t) {
  ...
  i.addTest = function (e, t) {
    if (_typeof(e) == "object") for (var r in e) {
...
(function (e, t, n) {
  ...
  _k = function k(e) {
    ...
    if (i(e)) o(e, 0, c, 0);else if (S(e)) for (a = 0; a < e.length; a++) {
...
(function (e) {
  ...
  t.prototype.animateSlide = function (t, n) {
    var r = {},
        i = this;
    if (i.transformsEnabled === !1) i.options.vertical === !1 ? i.$slideTrack.animate({
      left: t
    }, i.options.speed, i.options.easing, n) : i.$slideTrack.animate({
      top: t
    }, i.options.speed, i.options.easing, n);else if (i.cssTransitions === !1) e({
  ...
  t.prototype.checkResponsive = function () {
    ...
    if (t.originalSettings.responsive && t.originalSettings.responsive.length > -1 && t.originalSettings.responsive !== null) {
      ...
      for (n in t.breakpoints) {
        t.breakpoints.hasOwnProperty(n) && e(window).width() < t.breakpoints[n] && (r = t.breakpoints[n]);
      }
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","wp-content/plugins/x-shortcodes/js/dist/site/x-shortcodes-head.min.js"], null)
//# sourceMappingURL=/x-shortcodes-head.min.789c3166.js.map